...
MC6470_reg_value MC6470_MAG_validate_register_write(MC6470_reg_addr register_address, MC6470_reg_value value)
{
    ...
    {
        case MC6470_MAG_STATUS_ADDR:
        {
            return (((~MC6470_MAG_STATUS_ADDR_VALIDATION_MASK & value) | (MC6470_MAG_STATUS_ADDR_VALIDATION_MASK & MC6470_MAG_STATUS_ADDR_VALIDATION_VALUE)));
        }break;
        case MC6470_MAG_CTRL_2_ADDR:
        {
            return (((~MC6470_MAG_CTRL_2_ADDR_VALIDATION_MASK & value) | (MC6470_MAG_CTRL_2_ADDR_VALIDATION_MASK & MC6470_MAG_CTRL_2_ADDR_VALIDATION_VALUE)));
        }break;
        default:break;
    }
    return value;
